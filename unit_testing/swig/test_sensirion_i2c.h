 ...
 * @return      NO_ERROR on success, an error code otherwise
 */
/*int16_t sensirion_i2c_read_words(const struct i2c_dt_spec *i2c_spec,
 ...
 * @return      NO_ERROR on success, an error code otherwise
 */
/*int16_t sensirion_i2c_read_words_as_bytes(const struct i2c_dt_spec *i2c_spec,
                                          uint8_t *data, uint16_t num_words);*/
 ...
 * @return      NO_ERROR on success, an error code otherwise
 */
/*int16_t sensirion_i2c_write_cmd(const struct i2c_dt_spec *i2c_spec,
                                uint16_t command);*/
 ...
 * @return      NO_ERROR on success, an error code otherwise
 */
/*int16_t sensirion_i2c_write_cmd_with_args(const struct i2c_dt_spec *i2c_spec,
                                          uint16_t command,
 ...
 * @return      NO_ERROR on success, an error code otherwise
 */
/*int16_t sensirion_i2c_delayed_read_cmd(const struct i2c_dt_spec *i2c_spec,
                                       uint16_t cmd, uint32_t delay_us,
                                       uint16_t *data_words,
                                       uint16_t num_words);*/
/**
 ...
 */
/*int16_t sensirion_i2c_write_data(const struct i2c_dt_spec *i2c_spec,
 ...
 * @return            NO_ERROR on success, an error code otherwise
 */
/*int16_t sensirion_i2c_read_data_inplace(const struct i2c_dt_spec *i2c_spec,
                                        uint8_t *buffer,
